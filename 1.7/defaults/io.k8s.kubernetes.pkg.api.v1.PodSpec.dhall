...
, containers = [] : List ./../types/io.k8s.kubernetes.pkg.api.v1.Container.dhall
, hostAliases =
    [] : List ./../types/io.k8s.kubernetes.pkg.api.v1.HostAlias.dhall
, imagePullSecrets =
    [] : List ./../types/io.k8s.kubernetes.pkg.api.v1.LocalObjectReference.dhall
, initContainers =
    [] : List ./../types/io.k8s.kubernetes.pkg.api.v1.Container.dhall
, nodeSelector = [] : List { mapKey : Text, mapValue : Text }
, tolerations =
    [] : List ./../types/io.k8s.kubernetes.pkg.api.v1.Toleration.dhall
...
, securityContext =
    None ./../types/io.k8s.kubernetes.pkg.api.v1.PodSecurityContext.dhall
