...
, configMap :
    Optional ./io.k8s.kubernetes.pkg.api.v1.ConfigMapVolumeSource.dhall
, downwardAPI :
    Optional ./io.k8s.kubernetes.pkg.api.v1.DownwardAPIVolumeSource.dhall
...
, gitRepo : Optional ./io.k8s.kubernetes.pkg.api.v1.GitRepoVolumeSource.dhall
, glusterfs :
...
, persistentVolumeClaim :
    Optional
      ./io.k8s.kubernetes.pkg.api.v1.PersistentVolumeClaimVolumeSource.dhall
...
, projected :
    Optional ./io.k8s.kubernetes.pkg.api.v1.ProjectedVolumeSource.dhall
...
, secret : Optional ./io.k8s.kubernetes.pkg.api.v1.SecretVolumeSource.dhall
, storageos :
    Optional ./io.k8s.kubernetes.pkg.api.v1.StorageOSVolumeSource.dhall
, vsphereVolume :
