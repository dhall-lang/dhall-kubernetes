...
, hostPorts : (Optional (List ./io.k8s.api.extensions.v1beta1.HostPortRange.dhall))
, privileged : (Optional (Bool))
, readOnlyRootFilesystem : (Optional (Bool))
, requiredDropCapabilities : (Optional (List Text))
, runAsGroup : (Optional (./io.k8s.api.extensions.v1beta1.RunAsGroupStrategyOptions.dhall))
