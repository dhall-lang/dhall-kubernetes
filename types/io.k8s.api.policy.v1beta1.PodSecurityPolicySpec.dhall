...
, allowedFlexVolumes : (Optional (./io.k8s.api.policy.v1beta1.AllowedFlexVolume.dhall))
, allowedHostPaths : (Optional (./io.k8s.api.policy.v1beta1.AllowedHostPath.dhall))
...
, hostPorts : (Optional (./io.k8s.api.policy.v1beta1.HostPortRange.dhall))
