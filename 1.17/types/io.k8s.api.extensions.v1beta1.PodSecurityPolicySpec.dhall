...
, allowedCSIDrivers :
    Optional (List ./io.k8s.api.extensions.v1beta1.AllowedCSIDriver.dhall)
, allowedCapabilities : Optional (List Text)
, allowedFlexVolumes :
    Optional (List ./io.k8s.api.extensions.v1beta1.AllowedFlexVolume.dhall)
, allowedHostPaths :
    Optional (List ./io.k8s.api.extensions.v1beta1.AllowedHostPath.dhall)
...
, hostPorts :
    Optional (List ./io.k8s.api.extensions.v1beta1.HostPortRange.dhall)
, privileged : Optional Bool
, readOnlyRootFilesystem : Optional Bool
, requiredDropCapabilities : Optional (List Text)
, runAsGroup :
    Optional ./io.k8s.api.extensions.v1beta1.RunAsGroupStrategyOptions.dhall
, runtimeClass :
    Optional ./io.k8s.api.extensions.v1beta1.RuntimeClassStrategyOptions.dhall
