{ allowedCSIDrivers : List ./io.k8s.api.policy.v1beta1.AllowedCSIDriver.dhall
, allowedCapabilities : List Text
, allowedFlexVolumes : List ./io.k8s.api.policy.v1beta1.AllowedFlexVolume.dhall
, allowedHostPaths : List ./io.k8s.api.policy.v1beta1.AllowedHostPath.dhall
...
, hostPorts : List ./io.k8s.api.policy.v1beta1.HostPortRange.dhall
