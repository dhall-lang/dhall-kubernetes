...
, allowedCSIDrivers =
    None (List ./../types/io.k8s.api.policy.v1beta1.AllowedCSIDriver.dhall)
, allowedCapabilities = None (List Text)
, allowedFlexVolumes =
    None (List ./../types/io.k8s.api.policy.v1beta1.AllowedFlexVolume.dhall)
, allowedHostPaths =
    None (List ./../types/io.k8s.api.policy.v1beta1.AllowedHostPath.dhall)
...
, hostPID = None Bool
, hostPorts =
    None (List ./../types/io.k8s.api.policy.v1beta1.HostPortRange.dhall)
